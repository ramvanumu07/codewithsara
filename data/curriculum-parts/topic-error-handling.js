...
export default {
  ...
  "tasks": [
    ...
    },
    {
      ...
      "reference_solution": "function validateEmailFormat(email) {\n  try {\n    if (!email.includes('@')) throw new Error('Invalid email: missing @');\n    if (!email.includes('.')) throw new Error('Invalid email: missing domain');\n    return 'Valid email';\n  } catch (e) {\n    return e.message;\n  }\n}",
      "testCases": [
        {
          "input": {
