...
export default {
  ...
  "tasks": [
    ...
    {
      "description": "// Do not rename dateStr; it is the input. We may change it when testing.\nconst dateStr = \"2024-08-25\";\n\n// Create a Date from dateStr. Use getDay() (0=Sunday, 1=Monday, ..., 6=Saturday).\n// Use an array of day names (e.g. [\"Sunday\", \"Monday\", ...]) and index it with getDay().\n// Print the day name. For \"2024-08-25\" output should be: Sunday",
      "solution_type": "script",
    ...
    {
      "description": "// Do not rename dateStr; it is the input. We may change it when testing.\nconst dateStr = \"2024-08-15\";\n\n// Create a Date from dateStr. Build a string like \"August 15, 2024\" using:\n// - an array of month names (January ... December) indexed by getMonth()\n// - getDate() for the day\n// - getFullYear() for the year\n// For \"2024-08-15\" expected output: August 15, 2024",
      "solution_type": "script",
